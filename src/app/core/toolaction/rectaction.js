...
goog.provide('thin.core.toolaction.RectAction');
 ...
 */
thin.core.toolaction.RectAction = function() {
  thin.core.toolaction.DrawAction.call(this);
};
goog.inherits(thin.core.toolaction.RectAction, thin.core.toolaction.DrawAction);
 ...
 * @protected
 */
thin.core.toolaction.RectAction.prototype.handleActionInternal = function(e, workspace) {
