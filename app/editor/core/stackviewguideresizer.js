...
goog.provide('thin.core.StackViewGuideResizer');
goog.provide('thin.core.StackViewGuideResizer.DefaultSize_');
 ...
 * @param {thin.core.StackViewGuideHelper} affiliationGroup
 * @param {string} positionName
 * @constructor
 * @extends {thin.core.Component}
 */
thin.core.StackViewGuideResizer = function(layout, affiliationGroup, positionName) {
...
goog.inherits(thin.core.StackViewGuideResizer, thin.core.Component);
 ...
 * @private
 */
thin.core.StackViewGuideResizer.DefaultSize_ = {
  HANDLERSIZE: 15,
  ELEMENTSIZE: 2
};
 ...
 * @private
 */
thin.core.StackViewGuideResizer.prototype.decorationsContainer_;
 ...
 * @private
 */
thin.core.StackViewGuideResizer.prototype.rotate_;
 ...
 * @private
 */
thin.core.StackViewGuideResizer.prototype.handler_;
 ...
 * @private
 */
thin.core.StackViewGuideResizer.prototype.resizer_;
 ...
 * @private
 */
thin.core.StackViewGuideResizer.prototype.isRightPosition_ = false;
 ...
 * @private
 */
thin.core.StackViewGuideResizer.prototype.isBottomPosition_ = false;
 ...
 * @private
 */
thin.core.StackViewGuideResizer.prototype.isVertical_ = false;
 ...
 * @private
 */
thin.core.StackViewGuideResizer.prototype.isHorizon_ = false;
 ...
 * @private
 */
thin.core.StackViewGuideResizer.prototype.isCorner_ = false;


/**
 * @private
 */
thin.core.StackViewGuideResizer.prototype.init_ = function() {
...
thin.core.StackViewGuideResizer.prototype.setup = function() {
 ...
 * @private
 */
thin.core.StackViewGuideResizer.prototype.createResizers_ = function() {
  var layout = this.getLayout();
 ...
 */
thin.core.StackViewGuideResizer.prototype.adjustToResizerBounds = function(x, y, strokeWidth) {

  var layout = this.getLayout();
  var handlerSize = thin.core.StackViewGuideResizer.DefaultSize_.HANDLERSIZE / layout.getPixelScale();
 ...
 */
thin.core.StackViewGuideResizer.prototype.adjustToResizerBoundsForCorner = function(bounds) {
 ...
 * @param {goog.math.Rect} bounds
 */
thin.core.StackViewGuideResizer.prototype.adjustToResizerBoundsForVertical = function(bounds) {
 ...
 * @param {goog.math.Rect} bounds
 */
thin.core.StackViewGuideResizer.prototype.adjustToResizerBoundsForHorizon = function(bounds) {
...
thin.core.StackViewGuideResizer.prototype.reapplyStrokeAndSize = function() {
  var size = thin.core.StackViewGuideResizer.DefaultSize_.ELEMENTSIZE;
 ...
 */
thin.core.StackViewGuideResizer.prototype.getResizer = function() {
...
/** @inheritDoc */
thin.core.StackViewGuideResizer.prototype.disposeInternal = function() {
  ...
  thin.core.StackViewGuideResizer.superClass_.disposeInternal.call(this);
};
