...
goog.provide('thin.core.StackViewRowHelper');
...
thin.core.StackViewRowHelper = function(layout, shape) {
   ...
   * @private
   */
  this.separator_ = new thin.core.StackViewRowHelper.Separator_(layout);
 ...
 * @private
 */
thin.core.StackViewRowHelper.FILL_ = new goog.graphics.SolidFill('#AAAAAA');
 ...
 * @private
 */
thin.core.StackViewRowHelper.prototype.active_ = false;


/**
 * @param {thin.core.Component=} opt_renderTo
 */
thin.core.StackViewRowHelper.prototype.init = function(opt_renderTo) {
 ...
 * @return {boolean}
 */
thin.core.StackViewRowHelper.prototype.isActive = function() {
  return this.active_;
};
 ...
 */
thin.core.StackViewRowHelper.prototype.getDrawLayer = function() {
 ...
 * @return {thin.core.Layer}
 */
thin.core.StackViewRowHelper.prototype.getSelectorLayer = function() {
  return this.selectorLayer_;
};


/**
 * @return {thin.core.StackViewRowHelper.Separator_}
 */
thin.core.StackViewRowHelper.prototype.getSeparator = function() {
 ...
 */
thin.core.StackViewRowHelper.prototype.update = function(target, bounds) {
  var top = bounds.top;
...
thin.core.StackViewRowHelper.prototype.inactive = function() {
  if (this.isActive()) {
    var layout = this.layout_;
 ...
 * @private
 */
thin.core.StackViewRowHelper.prototype.createSelectorLayer_ = function() {
  var layout = this.layout_;
...
/** @inheritDoc */
thin.core.StackViewRowHelper.prototype.disposeInternal = function() {
  this.inactive();
  var layout = this.layout_;
 ...
 */
thin.core.StackViewRowHelper.Separator_ = function(layout) {
...
goog.inherits(thin.core.StackViewRowHelper.Separator_, thin.core.Component);
 ...
 * @private
 */
thin.core.StackViewRowHelper.Separator_.prototype.createLine_ = function() {
  return new thin.core.DraggableLine(
                    thin.core.DraggableLine.Direction.HORIZONTAL, this.layout_,
                    thin.core.StackViewRowHelper.FILL_);
};
 ...
 * @private
 */
thin.core.StackViewRowHelper.Separator_.prototype.createHandle_ = function() {
  return new thin.core.StackViewRowHelper.SeparatorHandle_(
 ...
 * @return {thin.core.DraggableLine}
 */
thin.core.StackViewRowHelper.Separator_.prototype.getLineHeight = function() {
  return this.line_.getHeight();
};


/** @override */
thin.core.StackViewRowHelper.Separator_.prototype.setup = function() {
...
thin.core.StackViewRowHelper.Separator_.prototype.init = function(rowHelper) {
  ...
  goog.events.listen(dragger, fxEventType.END, function(e) {
    ...
    var singleShape = activeShapeManagerByStackViewShape.getIfSingle();
    var isMultiple = activeShapeManagerByStackViewShape.isMultiple();
    ...
    layout.getWorkspace().normalVersioning(function(version) {
      ...
      version.upHandler(function() {
        updateStackViewShape(newSectionHeight, transLateCoordinate);
      }, scope);
 ...
 * @param {number} left
 */
thin.core.StackViewRowHelper.Separator_.prototype.setLeft = function(left) {
 ...
 * @private
 */
thin.core.StackViewRowHelper.Separator_.prototype.setHandleLeft_ = function(left) {
 ...
 * @param {number} top
 */
thin.core.StackViewRowHelper.Separator_.prototype.setTop = function(top) {
 ...
 * @param {number} width
 */
thin.core.StackViewRowHelper.Separator_.prototype.setWidth = function(width) {
 ...
 * @return {void}
 */
thin.core.StackViewRowHelper.Separator_.prototype.reapplySizeAndStroke = function() {
 ...
 */
thin.core.StackViewRowHelper.Separator_.prototype.getDragger = function() {
  return this.dragger_;
};


/** @override */
thin.core.StackViewRowHelper.Separator_.prototype.disposeInternal = function() {
 ...
 * @private
 */
thin.core.StackViewRowHelper.SeparatorHandle_ = function(element, layout) {
  goog.base(this, element, layout,
      null, new goog.graphics.SolidFill('#ffffff'));
};
goog.inherits(thin.core.StackViewRowHelper.SeparatorHandle_, thin.core.Rect);


thin.core.StackViewRowHelper.SeparatorHandle_.prototype.reapplySizeAndStroke = function() {
