...
goog.provide('thin.editor.toolaction.RectAction');
 ...
 */
thin.editor.toolaction.RectAction = function() {
  thin.editor.toolaction.DrawAction.call(this);
};
goog.inherits(thin.editor.toolaction.RectAction, thin.editor.toolaction.DrawAction);
 ...
 * @protected
 */
thin.editor.toolaction.RectAction.prototype.handleActionInternal = function(e, workspace) {

  var helpers = this.layout.getHelpers();
  var listHelper = helpers.getListHelper();
  var outline = helpers.getRectOutline();
